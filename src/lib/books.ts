export interface Book {
  ...
  progress: number; // 0..1
  chapter: string;
  coverHue: number; // 0..360 — drives stylized cover
  coverTone: "warm" | "cool" | "sage" | "ink";
  excerpt: string[]; // lines that will be "read aloud"
  activeLine: number; // index of currently-spoken line in excerpt
}
